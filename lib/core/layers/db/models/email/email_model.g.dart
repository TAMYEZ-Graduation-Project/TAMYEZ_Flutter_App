    ...
    if (list != null) {
      bytesCount += 3 + list.length * 3;
      {
        ...
        for (var i = 0; i < list.length; i++) {
          final value = list[i];
          bytesCount += RecipientSchema.estimateSize(
            value,
            offsets,
            allOffsets,
          );
...
Email _emailDeserialize(
  ...
  object.status =
      _EmailstatusValueEnumMap[reader.readByteOrNull(offsets[1])] ??
      Status.draft;
...
const _EmailstatusEnumValueMap = {'draft': 0, 'pending': 1, 'sent': 2};
...
extension EmailQueryFilter on QueryBuilder<Email, Email, QFilterCondition> {
  ...
  QueryBuilder<Email, Email, QAfterFilterCondition> recipientsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'recipients'),
      );
    });
  }
  ...
  QueryBuilder<Email, Email, QAfterFilterCondition> recipientsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'recipients'),
      );
    });
  }
  ...
  QueryBuilder<Email, Email, QAfterFilterCondition> recipientsLengthEqualTo(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'recipients', length, true, length, true);
    });
  }

  QueryBuilder<Email, Email, QAfterFilterCondition> recipientsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'recipients', 0, true, 0, true);
    });
  }

  QueryBuilder<Email, Email, QAfterFilterCondition> recipientsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'recipients', 0, false, 999999, true);
    });
  }
  ...
  QueryBuilder<Email, Email, QAfterFilterCondition> recipientsLengthLessThan(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'recipients', 0, true, length, include);
    });
  }
  ...
  QueryBuilder<Email, Email, QAfterFilterCondition> recipientsLengthGreaterThan(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'recipients', length, include, 999999, true);
    });
  }
  ...
  QueryBuilder<Email, Email, QAfterFilterCondition> titleContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Email, Email, QAfterFilterCondition> titleMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {

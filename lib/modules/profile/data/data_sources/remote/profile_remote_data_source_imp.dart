...
class ProfileRemoteDataSourceImp implements ProfileRemoteDataSource {
  ...
  Future<SimpleApiResponse> enableNotifications(
    ...
    return _profileApiClient.enableNotifications(request);
  }

  @override
  Future<SimpleApiResponse> refreshFcmToken(RefreshFcmTokenRequest request) {
    return _profileApiClient.refreshFcmToken(request);
  }
  ...
  Future<SimpleApiResponse> disableNotifications(
    ...
    return _profileApiClient.disableNotifications(request);
  }
}

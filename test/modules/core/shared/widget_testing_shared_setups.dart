...
/// Before using any fields from the object of this class, you must call sharedSetupAll and sharedSetup in there correct places class WidgetTestingSharedSetups {

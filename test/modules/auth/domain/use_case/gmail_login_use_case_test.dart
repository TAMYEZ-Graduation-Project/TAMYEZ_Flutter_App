...
void main() {
  ...
  late GmailLoginUseCase gmailLoginUseCase;
  ...
  setUp(() {
    ...
    gmailLoginUseCase = GmailLoginUseCase(mockAuthRepository);
  });

  group('gmailLogin function test', () {
    test(
      'Test gmailLogin function will call gmailLogin function in repository and return success if the call succeeds',
      () async {
        // arrange
        when(
          mockAuthRepository.gmailLogin(
        ...
        // act
        final result = await gmailLoginUseCase(rememberMe: true);
    ...
    test(
      'Test gmailLogin function will call gmailLogin function in repository and return failure if the call fails',
      () async {
        // arrange
        when(
          mockAuthRepository.gmailLogin(
